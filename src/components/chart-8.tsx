    ...
    return (
        <div className="年龄段-图2">
            ...
            <div className="legend">
                <span style={{ background: colors[0] }}>10-20</span>
                <span style={{ background: colors[1] }}>20-30 </span>
                <span style={{ background: colors[2] }}>30-40</span>
                <span style={{ background: colors[3] }}>40-50</span>
                <span style={{ background: colors[4] }}>50-60</span>
            </div>
        </div>
    );
};